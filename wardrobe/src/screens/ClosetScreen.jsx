...
function ClosetScreen({ products, savedProducts, activeFilter, onFilterChange, onOpenProduct }) {
  const uniqueBrands = new Set(savedProducts.map((product) => product.brand)).size;
  const savedValue = savedProducts.reduce((sum, product) => sum + product.price, 0);
    ...
    <section className="screen">
      ...
      <div className="stats-row">
        ...
        <div className="stat stat-wide">
          <span className="stat-value">{priceFormatter.format(savedValue)}</span>
        ...
        <div className="closet-grid">
          {products.length ? (
            ...
            <div className="empty-state">
              <strong>No saved pieces in {activeFilter.toLowerCase()} yet.</strong>
